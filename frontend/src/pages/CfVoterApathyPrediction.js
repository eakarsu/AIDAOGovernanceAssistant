...
/**
 * Gap/CFS Feature Page: Voter apathy prediction
 * Slug: voter-apathy-prediction
 * Backend: /api/cf-voter-apathy-prediction
 */
export default function VoterApathyPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-voter-apathy-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Voter apathy prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify likely low-turnout votes; send reminders to key stakeholders.</p>
