...
/**
 * Gap/CFS Feature Page: `proposals` lacks `/auto-generate-proposal` or `/analyze-proposal-language`.
 * Slug: proposals-lacks-auto-generate-proposal-or-analyze-proposal-l
 * Backend: /api/gap-proposals-lacks-auto-generate-proposal-or-analyze-proposal-l
 */
export default function ProposalsLacksAutoGenerateProposalOrAnalyzeProposalLPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-proposals-lacks-auto-generate-proposal-or-analyze-proposal-l', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`proposals` lacks `/auto-generate-proposal` or `/analyze-proposal-language`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`proposals` lacks `/auto-generate-proposal` or `/analyze-proposal-language`.</p>
