...
/**
 * Gap/CFS Feature Page: No historical voting-pattern analytics.
 * Slug: no-historical-voting-pattern-analytics
 * Backend: /api/gap-no-historical-voting-pattern-analytics
 */
export default function NoHistoricalVotingPatternAnalyticsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-historical-voting-pattern-analytics', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No historical voting-pattern analytics.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No historical voting-pattern analytics.</p>
