...
/**
 * Gap/CFS Feature Page: Treasury scenario modeling
 * Slug: treasury-scenario-modeling
 * Backend: /api/cf-treasury-scenario-modeling
 */
export default function TreasuryScenarioModelingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-treasury-scenario-modeling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Treasury scenario modeling</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Model impact of spending proposals on runway/financial health.</p>
