...
/**
 * Gap/CFS Feature Page: Limited governance platform integrations — no Snapshot/Aragon/Tally adapter.
 * Slug: limited-governance-platform-integrations-no-snapshot-aragon
 * Backend: /api/gap-limited-governance-platform-integrations-no-snapshot-aragon
 */
export default function LimitedGovernancePlatformIntegrationsNoSnapshotAragonPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-governance-platform-integrations-no-snapshot-aragon', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited governance platform integrations — no Snapshot/Aragon/Tally adapter.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited governance platform integrations — no Snapshot/Aragon/Tally adapter.</p>
