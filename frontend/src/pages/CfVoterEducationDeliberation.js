...
/**
 * Gap/CFS Feature Page: Voter education & deliberation
 * Slug: voter-education-deliberation
 * Backend: /api/cf-voter-education-deliberation
 */
export default function VoterEducationDeliberationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-voter-education-deliberation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Voter education & deliberation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Auto-generate pro/con summaries of proposals; suggest related prior votes; facilitate informed decision-making.</p>
