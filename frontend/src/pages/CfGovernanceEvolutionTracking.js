...
/**
 * Gap/CFS Feature Page: Governance evolution tracking
 * Slug: governance-evolution-tracking
 * Backend: /api/cf-governance-evolution-tracking
 */
export default function GovernanceEvolutionTrackingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-governance-evolution-tracking', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Governance evolution tracking</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Analyze historical votes; identify emerging DAO values/strategy shifts.</p>
