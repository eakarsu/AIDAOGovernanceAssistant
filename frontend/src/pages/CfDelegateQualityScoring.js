...
/**
 * Gap/CFS Feature Page: Delegate quality scoring
 * Slug: delegate-quality-scoring
 * Backend: /api/cf-delegate-quality-scoring
 */
export default function DelegateQualityScoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-delegate-quality-scoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Delegate quality scoring</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model scores delegates on past voting alignment with DAO values; recommend high-quality delegates.</p>
