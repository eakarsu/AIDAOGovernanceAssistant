...
/**
 * Gap/CFS Feature Page: `treasury` lacks AI scenario-modeling endpoint (despite `treasury-risk` AI route).
 * Slug: treasury-lacks-ai-scenario-modeling-endpoint-despite-treasur
 * Backend: /api/gap-treasury-lacks-ai-scenario-modeling-endpoint-despite-treasur
 */
export default function TreasuryLacksAiScenarioModelingEndpointDespiteTreasurPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-treasury-lacks-ai-scenario-modeling-endpoint-despite-treasur', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`treasury` lacks AI scenario-modeling endpoint (despite `treasury-risk` AI route).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`treasury` lacks AI scenario-modeling endpoint (despite `treasury-risk` AI route).</p>
